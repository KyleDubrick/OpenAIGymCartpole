...
t_loss = tf.where(
    ...
    t_abs)
t_train_step = tf.train.AdamOptimizer(learning_rate=0.1).minimize(t_loss)
...
for i_episode in range(num_episodes):
    ...
    mean /= 100
    count += 1
    print("Mean after last hundred trials: ", mean, " at episode :", i_episode)
    rList.append(rAll)
